...
| منبع | نقش | وضعیت |
| --- | --- | --- |
| جدول قوانین کاربر (`db07` / `LawItem.xlsx`) | قوانین موضوعه (`source_type=statute`) | **متن کامل** قوانین اصلی: مدنی، اساسی، مجازات ۱۳۹۹ + تعزیرات، آیین دادرسی مدنی و کیفری، کار، چک، مسئولیت مدنی، اجرای احکام، خانواده، موجر و مستأجر، جرائم رایانه‌ای، … (~۴۹۰۰ ماده). بقیهٔ ۹۶۲ عنوان هنوز وارد نشده. |
...
| qavanin.ir / ara.jri.ac.ir / ekhtebar.ir | منابع وب | backlog — PDFهای اختبار فایل تمیز JSON نیستند |
