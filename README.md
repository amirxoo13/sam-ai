...
| `amirxoo13/persian-legal-rag-jsonl` | قوانین خاص + نظریات مشورتی | ۱۸۰۰ قطعهٔ پالایش‌شده از ۸۲۴۶۴ خام: تجارت، ثبت، تأمین اجتماعی، اراضی، معادن، داوری، دیوان عدالت، … و ۴۰۰ نظریهٔ مشورتی. جزوه، تست و تکرار قوانین اصلی حذف شد. |
