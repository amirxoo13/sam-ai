...
| `amirxo13/iran-legal-corpus` (مخزن moshir) | قوانین ساخت‌یافته اختبار | **۱۰۶٬۸۷۲ مادهٔ جدید** از ۱۲۷۰ قانون کامل؛ تکرار مواد موجود در پیکرهٔ قبلی حذف شد. |
| `amirxoo13/power` (شاخص ۹۹۹۶ پرونده) | رویهٔ دادرسی (`case_law`) | **۹٬۹۹۶ پرونده** با هویت افراد حذف‌شده (نام، کد ملی، موبایل، نشانی). فقط موضوع، اتهام، وضعیت و متن رأی. |
