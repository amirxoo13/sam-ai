...
export function SignInButtons() {
  return (
    <Link
      to="/login"
      className="inline-flex h-11 min-h-11 w-full max-w-sm items-center justify-center rounded-[8px] border border-border bg-fg px-4 text-sm font-bold text-accent-fg"
    >
      ورود به سامانه
    </Link>
  );
