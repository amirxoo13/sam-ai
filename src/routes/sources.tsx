    ...
    <div className="flex min-h-dvh flex-col bg-bg">
      ...
      <main className="mx-auto w-full max-w-2xl flex-1 px-4 py-12">
        ...
        <h1 className="text-[26px] font-extrabold leading-[1.4]">
          فقط از متن واقعی؛ هرگز حدس نمی‌زند
        </h1>
        <p className="mt-4 text-[14px] leading-8 text-muted">
          SAM AI با روش <span className="text-fg">بازیابی برداری (RAG)</span>{" "}
          کار می‌کند: سؤال شما embed می‌شود، نزدیک‌ترین قطعات متنی از پایگاه
          دانش بازیابی می‌شوند، و پاسخ فقط بر اساس همان قطعات نوشته می‌شود.
          اگر پاسخ در منابع نباشد، SAM AI صادقانه می‌گوید نمی‌داند.
        </p>

        <div className="mt-8 grid gap-4">
          <SourceCard
            title="پیکره‌ی حقوقی و کیفری ایران"
            stat={`${stats.total.toLocaleString("fa-IR")} قطعه در پیکره`}
            items={[
